...
func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("itx", "itxpub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid - cosmos sender, itx recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
		...
		{
			"valid - itx sender, cosmos recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
		...
		{
			"valid - osmosis sender, itx recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/uitx",
			"10",
			sdk.Coin{Denom: "uitx", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped uitx coin",
			"uitx",
			"10",
			sdk.Coin{Denom: "uitx", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped uitx coin",
			"transfer/channel-0/uitx",
			"10",
			sdk.Coin{Denom: teststypes.UitxIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
