...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "itx_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "itx_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Itx_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "itx_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "itx_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "itx_itx_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "itx_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "itx_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
