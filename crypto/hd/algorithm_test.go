...
import (
	...
	cryptocodec "github.com/itxnetwork/itx/v12/crypto/codec"
	enccodec "github.com/itxnetwork/itx/v12/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("itx", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, itxtypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, itxtypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := hdwallet.MustParseDerivationPath(itxtypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Itx implementation
	...
	// Equality of Eth and Itx implementation
	...
	// Inequality of wrong derivation path of Eth and Itx implementation
