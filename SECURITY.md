...
Please refer to the official Itx [bug bounty program](https://immunefi.com/bounty/itx/)
...
- Use the Itx [bug bounty program](https://immunefi.com/bounty/itx/) on Immunefi to disclose all vulnerabilities,
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Itx in a
    ...
    5. A week (or less) after the security vulnerability has been patched on Itx,
...
including but not limited to Itx,
...
The Itx Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@itx.org](mailto:security@itx.org)
