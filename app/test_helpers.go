...
// Setup initializes a new Itx. A Nop logger is set in Itx.
func Setup(
	isCheckTx bool,
	...
	app := NewItx(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, encoding.MakeConfig(ModuleBasics), simapp.EmptyAppOptions{})
	if !isCheckTx {
...
func GenesisStateWithValSet(app *Itx, genesisState simapp.GenesisState,
...
func SetupTestingApp() (ibctesting.TestingApp, map[string]json.RawMessage) {
	...
	app := NewItx(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, cfg, simapp.EmptyAppOptions{})
