...
import (
	...
	evm "github.com/itxnetwork/itxitx/v12/x/evm/types"
	feemarkettypes "github.com/itxnetwork/itxitx/v12/x/feemarket/types"
	incentivestypes "github.com/itxnetwork/itxitx/v12/x/incentives/types"
...
func newEthAccount(baseAccount *authtypes.BaseAccount) itxtypes.EthAccount {
	return itxtypes.EthAccount{
