...
import (
	...
	"github.com/itxtitxitx/v12/x/claims/types"
...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "itx.claims.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "itx.claims.v1.V3Params")
}

func init() { proto.RegisterFile("itx/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
