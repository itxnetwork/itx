...
import (
	...
	"github.com/itxtitxitx/v12/x/erc20/types"
...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "itx.erc20.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "itx.erc20.v1.V3Params")
}

func init() { proto.RegisterFile("itx/erc20/v1/genesis.proto", fileDescriptor_2f4674601b0d6987) }
