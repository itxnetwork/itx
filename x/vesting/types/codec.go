...
const (
	// Amino names
	clawback                     = "itx/MsgClawback"
	createClawbackVestingAccount = "itx/MsgCreateClawbackVestingAccount"
	updateVestingFunder          = "itx/MsgUpdateVestingFunder"
	convertVestingAccount        = "itx/MsgConvertVestingAccount"
)
