...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "itx.inflation.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "itx.inflation.v1.V2Params")
}

func init() { proto.RegisterFile("itx/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
