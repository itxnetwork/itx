...
// The initial V2InflationDistribution can be calculated from the Itx Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "itx.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "itx.inflation.v1.V2ExponentialCalculation")
}

func init() {
	proto.RegisterFile("itx/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
