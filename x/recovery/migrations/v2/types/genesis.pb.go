...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "itx.recovery.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "itx.recovery.v1.V2Params")
}

func init() { proto.RegisterFile("itx/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
