...
// RANDAO implementation. See https://github.com/itxnetwork/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		...
		GasLimit:    itxtypes.BlockGasLimit(ctx),
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := itxtypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context,
	...
	// for more info https://github.com/itxnetwork/ethermint/issues/1085
