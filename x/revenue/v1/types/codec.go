...
const (
	// Amino names
	cancelRevenueName   = "itx/MsgCancelRevenue"
	registerRevenueName = "itx/MsgRegisterRevenue"
	updateRevenueName   = "itx/MsgUpdateRevenue"
	updateParamsName    = "itx/MsgUpdateParams"
)
