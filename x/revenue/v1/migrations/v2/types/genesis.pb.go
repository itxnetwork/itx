...
import (
	...
	"github.com/itxtitxitx/v12/x/revenue/v1/types"
...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "itx.revenue.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "itx.revenue.v1.V2Params")
}

func init() { proto.RegisterFile("itx/revenue/v1/genesis.proto", fileDescriptor_649d64d9c3438055) }
