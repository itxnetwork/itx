...
const (
	// MainnetChainID defines the Itx EIP155 chain ID for mainnet
	MainnetChainID = "itx_9001"
...
// IsTestnet returns true if the chain-id has the Itx testnet EIP155 chain prefix.
...
// GetItxAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `itx`).
// The function fails if the provided bech32 address is invalid.
func GetItxAddressFromBech32(address string) (sdk.AccAddress, error) {
