...
// TestItxVersionsLess tests the ItxVersions type's Less method with
// different version strings
func TestItxVersionsLess(t *testing.T) {
	var version ItxVersions
...
// TestItxVersionsSwap tests the ItxVersions type's Swap method
func TestItxVersionsSwap(t *testing.T) {
	var version ItxVersions
	value := "v9.1.0"
...
// TestItxVersionsLen tests the ItxVersions type's Len method
func TestItxVersionsLen(t *testing.T) {
	var version ItxVersions = []string{"v9.1.0", "v10.0.0"}
