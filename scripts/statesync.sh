...
# Initialize chain.
itxd init test --chain-id itx_9000-2

# Get Genesis
wget https://archive.itx.org/mainnet/genesis.json
mv genesis.json ~/.itxd/config/

wget -O ~/.itxd/config/adrbook.json https://snapshot.notional.ventures/itx/addrbook.json
...
export itxD_P2P_MAX_NUM_INBOUND_PEERS=200
export itxD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export itxD_STATESYNC_RPC_SERVERS="https://itx-rpc.polkachu.com:443,https://rpc-itx-ia.notional.ventures:443"
