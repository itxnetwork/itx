...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*itxtypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*itxtypes.TxResult, error)
...
func NewBackend(
	...
	chainID, err := itxtypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
